 ...
 */
@Service
public class CanalKafkaBridge implements SmartLifecycle {  // SmartLifecycle接口控制组件(Bean)的自动启动/关闭和顺序
    ...
    private volatile boolean running;           // volatile保证running变化的可见性和有序性
    private final TaskExecutor taskExecutor;    // 全局线程池
