...
@Data
@ConfigurationProperties(prefix = "spring.elasticsearch")  // 绑定到application.yml的属性
public class EsProperties {
    private List<String> uris;    // ES节点url, 支持多个 ES 节点：spring.elasticsearch.uris
